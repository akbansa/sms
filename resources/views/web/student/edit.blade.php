                    ...
                    <form id="updateForm" class="form-group" method="POST" action="{{route('student.edit.put', ['id' => $student->id ]) }}">
                        ...
                        <label class="label" for="name">
                            <input id="name" name="name" placeholder="Name" class="form-control" type="text" min="3"
                                   value="{{ isset(old()['name']) ? old()['name'] : $student->name }}" />
                        </label>
                        @if($errors->has('name'))
                        ...
                        <label class="label" for="address">
                            <textarea id="address" name="address" placeholder="Address" rows="5" class="form-control">@if(old('address')){{old('address')}}@else{{$student->address}}@endif</textarea>
                        </label>
